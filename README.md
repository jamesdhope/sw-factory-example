...
The **Software Factory** is a multi-agent orchestration system that automates the full software development lifecycle using **Goose-OS**.
...
## 📦 Build Artifacts
Each project run is isolated in the `builds/` directory with its own incremented ID, containing specs, task lists, and source code modules.
